###########################################################################
## Makefile generated for Simulink model 'Lander_Code_Model_2020a'. 
## 
## Makefile     : Lander_Code_Model_2020a.mk
## Generated on : Tue Mar 16 20:58:11 2021
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Lander_Code_Model_2020a.elf
...
PRODUCT_NAME              = Lander_Code_Model_2020a
MAKEFILE                  = Lander_Code_Model_2020a.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB~1
MATLAB_BIN                = C:/PROGRA~1/MATLAB~1/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/sm8g17/ONEDRI~1/Matlab/GDP
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = Lander_Code_Model_2020a_comp.rsp
CMD_FILE                  = Lander_Code_Model_2020a.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Lander_Code_Model_2020a.elf
...
DEFINES_ = -DMODEL=Lander_Code_Model_2020a -DNUMST=2 -DNCSTATES=12 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DUSE_STDPERIPH_DRIVER -DUSE_STM32F4_DISCOVERY -DSTM32F4XX -DARM_MATH_CM4=1 -D__FPU_PRESENT=1 -D__FPU_USED=1U -DHSE_VALUE=8000000 -DNULL=0 -D__START=_start -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DUSE_RTX -DOS_ROBIN=0 -DOS_TIMERS=1 -DOS_TIMERPRIO=6 -DOS_TIMERSTKSZ=200 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DOS_CLOCK=168000000 -DOS_TICK=50000 -DMW_BASERATEMULTIPLIER=2 -DOS_TASKCNT=2 -DOS_STKSIZE=1088 -DOS_MAINSTKSIZE=512
...
DEFINES_STANDARD = -DMODEL=Lander_Code_Model_2020a -DNUMST=2 -DNCSTATES=12 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Lander_Code_Model_2020a.o Lander_Code_Model_2020a_data.o blapp_support.o startup_stm32f4xx.o syscalls_stm32f4xx.o stm32f4xx_init_board.o system_stm32f4xx.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Lander_Code_Model_2020a_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Lander_Code_Model_2020a_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Lander_Code_Model_2020a_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Lander_Code_Model_2020a_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Lander_Code_Model_2020a_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Lander_Code_Model_2020a_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Lander_Code_Model_2020a.o : $(START_DIR)/Lander_Code_Model_2020a_ert_rtw/Lander_Code_Model_2020a.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Lander_Code_Model_2020a_data.o : $(START_DIR)/Lander_Code_Model_2020a_ert_rtw/Lander_Code_Model_2020a_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
