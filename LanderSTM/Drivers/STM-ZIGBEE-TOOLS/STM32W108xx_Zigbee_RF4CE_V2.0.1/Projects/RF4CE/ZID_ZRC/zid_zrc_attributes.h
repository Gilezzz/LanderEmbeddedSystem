/**
  ******************************************************************************
  * @file    zid_rf4ce_attributes.h
  * @author  MCD Application Team
  * @version V2.0.1
  * @date    30-November-2012 
  * @brief   ZID ZRC Device attributes header file
  ******************************************************************************
  * @attention
  *
...
/**
 * @addtogroup zid_zrc_attributes ZID ZRC ATTRIBUTES API
 * See zid_rf4ce_attributes.h for source code.
 * @{
 */

#ifndef ZID_ZRC_ATTRIBUTES_H
#define ZID_ZRC_ATTRIBUTES_H
...
/**
  * @name ZRC RF4CE attributes
  *@{
  */

/**
  * @brief The interval in ms at which user command repeat 
  * frames will be transmitted.
  * Value is 50 ms (0.5 * aplcMaxkeyRepeatInterval).
  * Valid range is 0-aplcMaxkeyRepeatInterval
  */
#define aplKeyRepeatInterval_ID      0x80
#define aplKeyRepeatInterval_Default 50000

/**
  * @brief The duration that a recipient of a user control repeated
  * command frame waits before terminating a repeated operation.
  * Value is 200 ms (2 * aplcMaxKeyRepeatInterval). 
  * Valid range is >= 2 * aplcMaxKeyRepeatInterval
  */
#define aplKeyRepeatWaitTime_ID      0x81
#define aplKeyRepeatWaitTime_Default 200000

/**
  * @} 
  */ /* END ZRC RF4CE attributes */ 
...
/** @brief This function sets the ZRC command device supported, the max length is 32 bytes
  *  @param cmdSupported lists of command supported
  *  @param cmdLength length of the list (max 32 bytes)
  *  @retval operation result. Valid value are:
  * - HID_ATTR_SUCCESS
  * - HID_ATTR_UNSUPPRTED 
  * - HID_ATTR_ILLEGAL_REQ
...
/** @brief This function gets the ZRC command device supported.
  *  @param cmdSupported lists of command supported
  *  @param cmdLength length of the list (max 32 bytes)
  *  @retval operation result. Valid value are:
  * - HID_ATTR_SUCCESS
