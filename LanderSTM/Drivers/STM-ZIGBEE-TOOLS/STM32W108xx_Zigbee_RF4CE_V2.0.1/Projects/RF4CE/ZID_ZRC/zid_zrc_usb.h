...
#ifndef ZID_ZRC_USB_H
#define ZID_ZRC_USB_H
...
/**
  ...
  *
  * See zid_zrc_usb.h for source code.
  * @{
  */

/**
  * @addtogroup HID USB descriptor constants
  * @{
  */
...
/**
  * @addtogroup HID USB Class Driver return values
  * @{
  */
...
/**
  * @addtogroup HID USB Class Driver typedefs
  * @{
  */
/**
...
/**
  * @addtogroup HID USB Class Driver function user interface
  * @{
  */
...
/** @brief This function sets the device attributes necessary to build all the 
  ...
  *  @return The status of the command. The values are:
...
/** @brief This function returns the byte received from serial input that haven't
  ...
  *  @return TRUE if some data is present, FALSE otherwise
  */
