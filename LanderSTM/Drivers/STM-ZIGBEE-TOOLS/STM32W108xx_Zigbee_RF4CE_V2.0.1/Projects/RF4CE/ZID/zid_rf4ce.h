...
/**
  * @addtogroup zid_rf4ce ZID RF4CE API
  * See zid_rf4ce.h for source code.
  * @{
  */
...
#include  "rf4ce.h"
#include  "nvm.h"
#include  "zid_rf4ce_constants.h"
#include  "zid_rf4ce_attributes.h"
#include  "zid_rf4ce_usb.h"

#ifndef DOXYGEN_SHOULD_SKIP_THIS
/**
  * @name ZID RF4CE version defines
  * @{
  */
...
/**
  ...
  */
#define ZID_RF4CE_VERSION_MAJOR 2

/**
  * @brief Version minor number
  */
#define ZID_RF4CE_VERSION_MINOR 0

/**
  * @brief Version patch number
  */
#define ZID_RF4CE_VERSION_PATCH 0

/**
  * @brief Version qualifier
  */
#define ZID_RF4CE_VERSION_QUAL  ""
...
/**
  ...
  */
#define ZID_RF4CE_VERSION_STRING QUOTEME(ZID_RF4CE_VERSION_MAJOR) "." QUOTEME(ZID_RF4CE_VERSION_MINOR) "." QUOTEME(ZID_RF4CE_VERSION_PATCH) ZID_RF4CE_VERSION_QUAL

/* @} \END ZID RF4CE version defines */
#endif
/**
  * @name ZID RF4CE Types
  *@{
  */
...
/**@brief  Device Init
  ...
  *          - RF4CE_SAP_PENDING
  */
uint32_t ZID_DeviceInit(uint8_t deviceType, bool coldStart);
