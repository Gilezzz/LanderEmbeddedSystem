/**
  ******************************************************************************
  * @file    zid_rf4ce_constants.h
  * @author  MCD Application Team
  * @version V2.0.1
  * @date    30-November-2012 
  * @brief   ZID RF4CE constants header file
  ******************************************************************************
  * @attention
  *
...
/**
  * @addtogroup zid_rf4ce_contsants ZID RF4CE CONSTANTS
  * See zid_rf4ce_constants.h for source code.
  * @{
  */

#ifndef ZID_RF4CE_CONSTANTS_H
#define ZID_RF4CE_CONSTANTS_H

/**
  * @name ZID RF4CE Device Type
  *@{
  */
...
/**
  * @name GDP RF4CE constants used by the ZID profile
  *@{
  */
...
/**
  * @name GDP RF4CE NIB attributes init values used by the ZID profile
  *@{
  */
...
/**
  * @name GDP RF4CE command frame utilized by the ZID profile
  *@{
  */
...
/**
  * @name Generic RF4CE command code utilized for ZID profile
  *@{
  */
