/**
  ******************************************************************************
  * @file    zid_rf4ce_transport.h
  * @author  MCD Application Team
  * @version V2.0.1
  * @date    30-November-2012 
  * @brief   ZID USB transport header file
  ******************************************************************************
  * @attention
  *
...
/**
  *@addtogroup ZID USB Transport API
  *See zid_transport.h for source code.
  *@{
  */
#ifndef ZID_RF4CE_TRANSPORT_H
#define ZID_RF4CE_TRANSPORT_H

/**
  *@name HID TRANSPORT constant
  *@{
  */
