...
/* Definitions for stateUDTask */
osThreadId_t stateUDTaskHandle;
const osThreadAttr_t stateUDTask_attributes = {
  .name = "stateUDTask",
...
int main(void)
{
  ...
  /* -------------------------------------------------------------------------- */
  /* Create the thread(s) */
  /* creation of stateUDTask */
  stateUDTaskHandle = osThreadNew(stateUpdate, NULL, &stateUDTask_attributes);

  /* creation of altitudeTask */
  altitudeTaskHandle = osThreadNew(altitude, NULL, &altitudeTask_attributes);

  /* creation of attitudePDTask */
  attitudePDTaskHandle = osThreadNew(atttitudePD, NULL, &attitudePDTask_attributes);
...
/**
* @brief Function implementing the altitudeTask thread.
* @param argument: Not used
* @retval None
*/
...
void altitude(void *argument)
{
  /* USER CODE BEGIN altitude */
	/*
	 * 1: Update the current altitude value
	 */
  /* Infinite loop */
  for(;;)
  {
...
/**
* @brief Function implementing the recordTransTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_recordTransmit */
void recordTransmit(void *argument)
{
  /* USER CODE BEGIN recordTransmit */
  /** TODO
   * Collect the current orientation/acceleration/speed/altitude/current state infomration and send via radio to the ground
   * Record the instruction to drop? Trigger something else which switches the state?
   * */
  for(;;)
  {
    osDelay(1);
...
* @retval None
*/
/* USER CODE END Header_attitude */
void attitude(void *argument)
{
  /* USER CODE BEGIN attitude */
  /* Infinite loop */
  for(;;)
  {
    Update_Att_DES();
...
* @retval None
*/
/* USER CODE END Header_ignitionTask */
void ignitionTask(void *argument)
{
